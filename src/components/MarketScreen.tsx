...
const ITEMS = [
  { title: 'Steel collar with D-ring, mirror finish', price: '$150', seller: 'ironlace', initial: 'I', grad: '135deg,#00FFC2,#5FD000', rating: 78, tags: ['Metal', '📍 Silver Lake'] },
  { title: 'Handmade restraint cuffs, matte black', price: '$120', seller: 'velvetbound', initial: 'V', grad: '135deg,#9EFF00,#00FFC2', rating: 92, tags: ['Leather', '📦 Ships'] },
  ...
  { title: 'Steel-boned corset, custom sizing', price: '$185', seller: 'velvetbound', initial: 'V', grad: '135deg,#5FD000,#9EFF00', rating: 92, tags: ['Apparel', '📦 Ships'] },
